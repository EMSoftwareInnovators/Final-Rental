/* ============================================================
   input.js -- keyboard, mouse look with pointer lock, and a
   one-shot "pressed this frame" edge buffer for menus.
   ============================================================ */
export class Input {
  constructor(target) {
    this.target = target;
  ...
  _bind() {
    ...
    addEventListener('blur', () => { this.down.clear(); this.mouse = [false, false, false]; });
